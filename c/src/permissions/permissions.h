...
struct TablePermissions {
    // Allows the account to be able see characteristics of the table and interact with it in any way.
    // If this permission is denied, any query specifically on the table will be denied.
    // The table will still show up for the account when querying all tables.
